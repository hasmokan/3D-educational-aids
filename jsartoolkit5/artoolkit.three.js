...
(function() {
	var integrate = function() {
		...
		*/
		ARController.prototype.createThreeMarker = function(markerUID, markerWidth) { var start = new Date().getTime();
			
			this.setupThree();
			var obj = new THREE.Object3D();
			obj.markerTracker = this.trackPatternMarkerId(markerUID, markerWidth);
			obj.matrixAutoUpdate = false;
			this.threePatternMarkers[markerUID] = obj; var end = new Date().getTime();
